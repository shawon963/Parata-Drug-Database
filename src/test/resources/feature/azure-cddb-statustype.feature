Feature: DrugStatus Table Data and column Test between PDDB_LP and DrugDB Database
  Scenario: Verify StatusType Table Data and column Test between PDDB_LP and DrugDB Database
    ...
    And user should verify StatusType table column between SP_Pull_Status procedure column in PDDB_LP database within azure server and "StatusType" table column in DrugDB database within CDDB server
    And user should verify StatusType table data count between SP_Pull_Status procedure data in PDDB_LP database within azure server and "StatusType" table data in DrugDB database within CDDB server